<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.Date,in.ac.nitc.permission.dbconnection.DBConnection"%>
			 ...
			 <table cellspacing="20" align="center">
			  ...
			  <%
				...
				Date myDate = new Date();
               	...
               	currDate+=" 00:00:00";
				try {
					query="select * from  Permission where status='approved' and start_datetime >= ? order by start_datetime";
